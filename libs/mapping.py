...
CONNECTOR_GAMMA_TRANSACTION: dict[str, Any] = {
    ...
    "entity_type": "TRANSACTION",
    "fields": [
        {"target": "external_transaction_id", "source": "EventId",            "transform": "copy"},
        {"target": "player_cpf",              "source": "PlayerId",           "transform": "copy"},
        {"target": "type",                    "source": "Type",               "transform": "mapEnum",
         "params": {"DEPOSIT": "DEPOSIT", "WITHDRAWAL": "WITHDRAWAL", "DEP": "DEPOSIT", "WD": "WITHDRAWAL"}},
        {"target": "amount",                  "source": "Amount",             "transform": "coerceDecimal"},
        {"target": "currency",                "source": "Amount.currency",    "transform": "copy"},
        {"target": "occurred_at",             "source": "Timestamp",          "transform": "parseDate"},
        {"target": "device_id",               "source": "DeviceId",           "transform": "copy"},
        {"target": "method",                  "source": "Instrument.Type",    "transform": "copy"},
...
CONNECTOR_DELTA_TRANSACTION: dict[str, Any] = {
    ...
    "entity_type": "TRANSACTION",
    "fields": [
        {"target": "external_transaction_id", "source": "id",              "transform": "copy"},
        {"target": "player_cpf",              "source": "uid",             "transform": "copy"},
        {"target": "type",                    "source": "evt_type",        "transform": "normalize",
         "params": {"deposit": "DEPOSIT", "dep": "DEPOSIT", "withdrawal": "WITHDRAWAL", "wd": "WITHDRAWAL", "bet": "BET"}},
        {"target": "amount",                  "source": "val",             "transform": "coerceDecimal"},
        {"target": "currency",                "source": "ccy",             "transform": "copy"},
