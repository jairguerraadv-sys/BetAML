...
class ScoringConfig(Base):
    ...
    min_precision                   = Column(Numeric(5, 4), nullable=False, default=0.80)
    max_false_positive_rate         = Column(Numeric(5, 4), nullable=False, default=0.20)
    min_recall                      = Column(Numeric(5, 4), nullable=True)
    require_manual_approval         = Column(Boolean, nullable=False, default=True)
