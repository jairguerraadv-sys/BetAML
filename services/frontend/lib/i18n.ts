...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  'pt-BR': {
    ...
    'nav.coaf': 'Comunicação ao Coaf',
    'nav.reports': 'Relatórios',
    'nav.notifications': 'Notificações',
    'nav.admin': 'Administração',
    'nav.rules': 'Regras e Cenários',
    'nav.rules_builder': 'Criador de Regras',
    'nav.player_lists': 'Listas de Monitoramento',
    'nav.model_registry': 'Registro de Modelos',
    'nav.feature_store': 'Repositório de Variáveis',
    'nav.mappings': 'Mapeamentos de Dados',
    'nav.ingest_jobs': 'Importações de Dados',
    'nav.ingest_errors': 'Erros de Importação',
    'nav.audit_logs': 'Registro de Auditoria',
    'nav.settings': 'Configurações',
    'nav.sensitivity': 'Sensibilidade',
    'nav.signout': 'Sair',
    'nav.dark_mode': 'Modo escuro',
    'nav.light_mode': 'Modo claro',
    'nav.search_placeholder': 'Buscar CPF, nome, caso ou alerta…',
    ...
    'cases.status.investigating': 'Em investigação',
    ...
    'cases.decision.file_cos': 'Comunicar ao Coaf',
    'cases.decision.no_action': 'Arquivar sem comunicar',
    'cases.decision.monitor': 'Manter em monitoramento',
    'cases.decision.escalate': 'Escalar para supervisor',

    // Coaf / COS
    'coaf.title': 'Comunicação ao Coaf',
    'coaf.cos': 'COS',
    'coaf.cos_full': 'Comunicação de Operação Suspeita',
    'coaf.new': 'Nova Comunicação',
    'coaf.status.draft': 'Rascunho',
    'coaf.status.ready': 'Pronta para enviar',
    'coaf.status.sent': 'Comunicada',
    'coaf.status.pending_protocol': 'Aguardando protocolo',
    'coaf.protocol': 'Protocolo Coaf',
    'coaf.deadline': 'Prazo Coaf',
    'coaf.deadline_warning': 'Prazo próximo',
    'coaf.deadline_breach': 'Prazo vencido',
