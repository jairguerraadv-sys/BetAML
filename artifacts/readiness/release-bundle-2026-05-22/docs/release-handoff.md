...
## Evidencia adicional - Fase 1 (API regressao ampliada)

- Suite security + auth + ingest executada com stack local ativa (`TEST_STACK_UP=1`)
- Resultado: `145` coletados, `137` passed, `8` skipped, `0` failed
- Artefatos:
